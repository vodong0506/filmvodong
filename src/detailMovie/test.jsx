...
const DetailMovie = () => {
  ...
  return (
    <>
      <div className="relative w-full text-white bg-[rgb(18,19,28)] h-full">
        <div className="relative w-full h-screen z-11">
          {/* Background Image */}
          <div
          ...
          >
            {/* Gradient Overlay */}
            <div className="absolute inset-0 bg-linear-to-r from-black/90 via-black/50 to-black/30"></div>
          ...
          <div className="relative z-10">
            {/* Main Content */}
            <div className="px-4 md:px-8 lg:px-16 pb-16 bg-[rgb(13,13,12)] pt-10 mt-120">
